...
| **P3** | 階段 3 | Migration 代碼化與對照表 | 目錄命名帶穩定代碼、`migrations/README.md`、各 `migration.sql` 檔頭摘要。**P4 baseline 產出後**新鏈從 **MIG001** 起編碼；舊鏈封存至 `migrations/_archive/`，不改檔名（見 **應用部署與營運**）。 | ✅ 已完成 |
