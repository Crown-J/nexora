...
- **跨模組或公版主題不寫進本日誌**、寫進 [_team/worklog.md](../_team/worklog.md)（D3 雙帳 / D4 Translator / B2 反查 / 公版 component / TASK-BUSINESS-RESTRUCTURE / A002 drift）
...
> ⚠️ 公版 component（DocLayout / DocListView / DocDetailView / DocHeader / DocItemTable / docStatus）跨模組共用、見 [_team/worklog.md 主題 4](../_team/worklog.md)。本主題只記 NX02 三張單據的 demo 用法。
...
- 跨模組或公版（D3 / D4 / B2 / TASK-BUSINESS-RESTRUCTURE / 公版 component / A002）**不寫進本日誌**、已寫進 [_team/worklog.md](../_team/worklog.md) 統合
