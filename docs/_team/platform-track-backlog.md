...
### A.7 訂閱定價待總經理確認（2026-06-02 順手記）

| 項 | 內容 |
|---|---|
| **LITE 月費 = 4500 元 + 400 元/座位** | seed/system/nx99_plan 既有值（NEXORA-LITE-M）、補恆迎沿用無妨。但這代表系統 LITE 定價現為此數、**簽真客戶前要對總經理確認是否真實定價** |
| **PLUS / PRO 各檔次定價** | 同上、簽真客戶前都需確認 |
| 影響 | 開戶 onboarding 自動建訂閱時 fee snapshot 直接拷貝 plan 表、價格不對會穿透到客戶賬單 |
