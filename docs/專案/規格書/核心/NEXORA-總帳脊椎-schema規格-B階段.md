...
<!-- 檔案版本：v0.4（B1~B4 已完成並 push 2026-08-01；§5 五題已拍板） -->
...
**版本** v0.4 ｜ **撰寫** Hank ｜ **日期** 2026-08-01 ｜ ✅ **§5 五題已全數照建議拍板**（執行長 2026-08-01）
...
| B4 | — | `carryForwardToPeriod` ＋ `closeFiscalYear` | `22-gl-period-close.ts` 16 項 |
