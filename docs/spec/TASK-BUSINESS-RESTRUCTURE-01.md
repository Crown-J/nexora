...
| v1.7 | 2026-04-23 | 大塊 3 Phase 10 完成:庫位管理頁 + 盤點設定頁 + WarehouseSection 啟用 |
...
| Phase 9 | ✅ 完成 | bc3d23c (大塊 3) | 庫存中心工作站:大塊 2 的 /dashboard/inventory-mobile/* 遷到 /dashboard/inventory/* + 進貨/盤點 placeholder |
| Phase 10 | ✅ 完成 | TBD (大塊 3) | 倉管 KPI(Phase 8 已做)+ 庫位管理頁 + 盤點設定頁,WarehouseSection 啟用 |
