...
| Phase | 狀態 | Commit | 內容 |
|-------|------|--------|------|
| Phase 1 | ✅ 完成 | TBD (大塊 1) | STEP 5 上一步迴圈 bug 修復(handleBack 從 STEP 6 回時 RESET_CUSTOMER_DECISION)|
| Phase 2 | ✅ 完成 | TBD (大塊 1) | 歷史報價機制 useHistoryRecord hook + HistoryQuoteAlert + MarginAlert(毛利警覺性)|
| Phase 3 | ✅ 完成 | TBD (大塊 1) | STEP 5 重構 5 選項 + 4 sub-flow dialogs + AddMoreDialog 追加品項 |
| Phase 4 | ✅ 完成 | TBD (大塊 1) | StatusSection 待辦改為 銷售進行中 / 調貨進行中 / 保固(詢/報已移除)|
| Phase 5 | ⏳ 待做 | - | SO 備貨 4 情境分流 |
