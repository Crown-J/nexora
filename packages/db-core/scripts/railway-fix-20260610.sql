...
*/
-- DropForeignKey
ALTER TABLE "nx01_import_batch" DROP CONSTRAINT IF EXISTS "fk_nx01_import_batch_tenant";

-- DropForeignKey
ALTER TABLE "nx01_import_batch" DROP CONSTRAINT IF EXISTS "fk_nx01_import_batch_uploader";

-- DropForeignKey
ALTER TABLE "nx01_role_permission" DROP CONSTRAINT IF EXISTS "fk_nx01_role_permission_permission";

-- DropForeignKey
ALTER TABLE "nx01_role_permission" DROP CONSTRAINT IF EXISTS "fk_nx01_role_permission_role";

-- DropForeignKey
ALTER TABLE "nx01_role_permission" DROP CONSTRAINT IF EXISTS "fk_nx01_role_permission_tenant";

-- DropForeignKey
ALTER TABLE "nx01_user_page_guide" DROP CONSTRAINT IF EXISTS "fk_nx01_user_page_guide_tenant";

-- DropForeignKey
ALTER TABLE "nx01_user_page_guide" DROP CONSTRAINT IF EXISTS "fk_nx01_user_page_guide_user";

-- DropForeignKey
ALTER TABLE "nx01_user_pref" DROP CONSTRAINT IF EXISTS "fk_nx01_user_pref_tenant";

-- DropForeignKey
ALTER TABLE "nx01_user_pref" DROP CONSTRAINT IF EXISTS "fk_nx01_user_pref_user";

-- DropForeignKey
ALTER TABLE "nx03_issue_report" DROP CONSTRAINT IF EXISTS "nx03_issue_report_location_id_fkey";

-- DropForeignKey
ALTER TABLE "nx03_issue_report" DROP CONSTRAINT IF EXISTS "nx03_issue_report_part_version_id_fkey";

-- DropForeignKey
ALTER TABLE "nx03_part_stock_setting" DROP CONSTRAINT IF EXISTS "nx03_part_stock_setting_default_location_id_fkey";

-- DropForeignKey
ALTER TABLE "nx05_ar_ledger" DROP CONSTRAINT IF EXISTS "fk_nx05_ar_ledger_pr_id";

-- DropForeignKey
ALTER TABLE "nx05_ar_ledger" DROP CONSTRAINT IF EXISTS "nx05_ar_ledger_so_id_fkey";

-- DropForeignKey
ALTER TABLE "nx05_ar_reminder_log" DROP CONSTRAINT IF EXISTS "fk_nx05_ar_reminder_log_ar";

-- DropForeignKey
ALTER TABLE "nx05_ar_reminder_log" DROP CONSTRAINT IF EXISTS "fk_nx05_ar_reminder_log_tenant";

-- DropForeignKey
ALTER TABLE "nx05_ar_reminder_log" DROP CONSTRAINT IF EXISTS "fk_nx05_ar_reminder_log_user";

-- DropForeignKey
ALTER TABLE "nx05_closing" DROP CONSTRAINT IF EXISTS "fk_nx05_closing_report_filed_by";

-- DropForeignKey
ALTER TABLE "nx05_paylog_settlement" DROP CONSTRAINT IF EXISTS "fk_nx05_paylog_settlement_ap";

-- DropForeignKey
ALTER TABLE "nx05_paylog_settlement" DROP CONSTRAINT IF EXISTS "fk_nx05_paylog_settlement_ar";

-- DropForeignKey
ALTER TABLE "nx05_paylog_settlement" DROP CONSTRAINT IF EXISTS "fk_nx05_paylog_settlement_paylog";

-- DropForeignKey
ALTER TABLE "nx05_paylog_settlement" DROP CONSTRAINT IF EXISTS "fk_nx05_paylog_settlement_tenant";

-- DropForeignKey
ALTER TABLE "nx10_checkin_log" DROP CONSTRAINT IF EXISTS "nx10_checkin_log_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_checkin_log" DROP CONSTRAINT IF EXISTS "nx10_checkin_log_user_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_emp_exp_log" DROP CONSTRAINT IF EXISTS "nx10_emp_exp_log_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_emp_exp_log" DROP CONSTRAINT IF EXISTS "nx10_emp_exp_log_user_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_emp_medal" DROP CONSTRAINT IF EXISTS "nx10_emp_medal_medal_level_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_emp_medal" DROP CONSTRAINT IF EXISTS "nx10_emp_medal_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_emp_medal" DROP CONSTRAINT IF EXISTS "nx10_emp_medal_user_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_emp_task_log" DROP CONSTRAINT IF EXISTS "nx10_emp_task_log_task_template_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_emp_task_log" DROP CONSTRAINT IF EXISTS "nx10_emp_task_log_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_emp_task_log" DROP CONSTRAINT IF EXISTS "nx10_emp_task_log_user_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_medal_level" DROP CONSTRAINT IF EXISTS "nx10_medal_level_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_mentorship_record" DROP CONSTRAINT IF EXISTS "nx10_mentorship_record_mentee_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_mentorship_record" DROP CONSTRAINT IF EXISTS "nx10_mentorship_record_mentor_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_mentorship_record" DROP CONSTRAINT IF EXISTS "nx10_mentorship_record_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_promotion_criteria" DROP CONSTRAINT IF EXISTS "nx10_promotion_criteria_from_role_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_promotion_criteria" DROP CONSTRAINT IF EXISTS "nx10_promotion_criteria_min_medal_level_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_promotion_criteria" DROP CONSTRAINT IF EXISTS "nx10_promotion_criteria_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_promotion_criteria" DROP CONSTRAINT IF EXISTS "nx10_promotion_criteria_to_role_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_promotion_request" DROP CONSTRAINT IF EXISTS "nx10_promotion_request_criteria_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_promotion_request" DROP CONSTRAINT IF EXISTS "nx10_promotion_request_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_promotion_request" DROP CONSTRAINT IF EXISTS "nx10_promotion_request_user_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_sprint_task" DROP CONSTRAINT IF EXISTS "nx10_sprint_task_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_sprint_task_log" DROP CONSTRAINT IF EXISTS "nx10_sprint_task_log_sprint_task_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_sprint_task_log" DROP CONSTRAINT IF EXISTS "nx10_sprint_task_log_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_sprint_task_log" DROP CONSTRAINT IF EXISTS "nx10_sprint_task_log_user_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_surprise_box_log" DROP CONSTRAINT IF EXISTS "nx10_surprise_box_log_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_surprise_box_log" DROP CONSTRAINT IF EXISTS "nx10_surprise_box_log_user_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_task_template" DROP CONSTRAINT IF EXISTS "nx10_task_template_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_team_task" DROP CONSTRAINT IF EXISTS "nx10_team_task_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_team_task" DROP CONSTRAINT IF EXISTS "nx10_team_task_warehouse_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_team_task_log" DROP CONSTRAINT IF EXISTS "nx10_team_task_log_team_task_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_team_task_log" DROP CONSTRAINT IF EXISTS "nx10_team_task_log_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "nx10_team_task_log" DROP CONSTRAINT IF EXISTS "nx10_team_task_log_warehouse_id_fkey";

-- DropIndex
DROP INDEX IF EXISTS "nx01_site_tenant_id_is_main_unique";
