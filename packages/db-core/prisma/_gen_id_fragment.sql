...
CREATE SEQUENCE IF NOT EXISTS seq_nx10_emp_exp_log_id START 1;
CREATE OR REPLACE FUNCTION gen_nx10_emp_exp_log_id()
RETURNS VARCHAR AS $$
  SELECT 'NX10EXPG' || LPAD(nextval('seq_nx10_emp_exp_log_id')::text, 7, '0');
$$ LANGUAGE sql;

CREATE SEQUENCE IF NOT EXISTS seq_nx10_emp_medal_id START 1;
CREATE OR REPLACE FUNCTION gen_nx10_emp_medal_id()
RETURNS VARCHAR AS $$
  SELECT 'NX10EMMD' || LPAD(nextval('seq_nx10_emp_medal_id')::text, 7, '0');
$$ LANGUAGE sql;

CREATE SEQUENCE IF NOT EXISTS seq_nx10_emp_task_log_id START 1;
CREATE OR REPLACE FUNCTION gen_nx10_emp_task_log_id()
RETURNS VARCHAR AS $$
  SELECT 'NX10EMTK' || LPAD(nextval('seq_nx10_emp_task_log_id')::text, 7, '0');
$$ LANGUAGE sql;

CREATE SEQUENCE IF NOT EXISTS seq_nx10_medal_level_id START 1;
CREATE OR REPLACE FUNCTION gen_nx10_medal_level_id()
RETURNS VARCHAR AS $$
  SELECT 'NX10MDLV' || LPAD(nextval('seq_nx10_medal_level_id')::text, 7, '0');
$$ LANGUAGE sql;

CREATE SEQUENCE IF NOT EXISTS seq_nx10_mentorship_record_id START 1;
CREATE OR REPLACE FUNCTION gen_nx10_mentorship_record_id()
RETURNS VARCHAR AS $$
  SELECT 'NX10MNSH' || LPAD(nextval('seq_nx10_mentorship_record_id')::text, 7, '0');
$$ LANGUAGE sql;

CREATE SEQUENCE IF NOT EXISTS seq_nx10_promotion_criteria_id START 1;
CREATE OR REPLACE FUNCTION gen_nx10_promotion_criteria_id()
RETURNS VARCHAR AS $$
  SELECT 'NX10PMCR' || LPAD(nextval('seq_nx10_promotion_criteria_id')::text, 7, '0');
$$ LANGUAGE sql;

CREATE SEQUENCE IF NOT EXISTS seq_nx10_promotion_request_id START 1;
CREATE OR REPLACE FUNCTION gen_nx10_promotion_request_id()
RETURNS VARCHAR AS $$
  SELECT 'NX10PMRQ' || LPAD(nextval('seq_nx10_promotion_request_id')::text, 7, '0');
$$ LANGUAGE sql;

CREATE SEQUENCE IF NOT EXISTS seq_nx10_sprint_task_id START 1;
CREATE OR REPLACE FUNCTION gen_nx10_sprint_task_id()
RETURNS VARCHAR AS $$
  SELECT 'NX10SPTK' || LPAD(nextval('seq_nx10_sprint_task_id')::text, 7, '0');
$$ LANGUAGE sql;

CREATE SEQUENCE IF NOT EXISTS seq_nx10_sprint_task_log_id START 1;
CREATE OR REPLACE FUNCTION gen_nx10_sprint_task_log_id()
RETURNS VARCHAR AS $$
  SELECT 'NX10SPTL' || LPAD(nextval('seq_nx10_sprint_task_log_id')::text, 7, '0');
$$ LANGUAGE sql;

CREATE SEQUENCE IF NOT EXISTS seq_nx10_surprise_box_log_id START 1;
CREATE OR REPLACE FUNCTION gen_nx10_surprise_box_log_id()
RETURNS VARCHAR AS $$
  SELECT 'NX10SPBX' || LPAD(nextval('seq_nx10_surprise_box_log_id')::text, 7, '0');
$$ LANGUAGE sql;

CREATE SEQUENCE IF NOT EXISTS seq_nx10_task_template_id START 1;
CREATE OR REPLACE FUNCTION gen_nx10_task_template_id()
RETURNS VARCHAR AS $$
  SELECT 'NX10TKTM' || LPAD(nextval('seq_nx10_task_template_id')::text, 7, '0');
$$ LANGUAGE sql;

CREATE SEQUENCE IF NOT EXISTS seq_nx10_team_task_id START 1;
CREATE OR REPLACE FUNCTION gen_nx10_team_task_id()
RETURNS VARCHAR AS $$
  SELECT 'NX10TMTK' || LPAD(nextval('seq_nx10_team_task_id')::text, 7, '0');
$$ LANGUAGE sql;

CREATE SEQUENCE IF NOT EXISTS seq_nx10_team_task_log_id START 1;
CREATE OR REPLACE FUNCTION gen_nx10_team_task_log_id()
RETURNS VARCHAR AS $$
  SELECT 'NX10TMTL' || LPAD(nextval('seq_nx10_team_task_log_id')::text, 7, '0');
$$ LANGUAGE sql;
