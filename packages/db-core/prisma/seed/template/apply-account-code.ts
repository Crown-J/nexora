...
//    新版 109 列改用亞羅《核心主檔 v1》體例 4101/5101/6201/6101。
//    換代前實測 nx05_account_code 0 筆、nx05_paylog 0 筆 → 無既有資料受影響。
//
// 資料來源：亞羅核心主檔-v1.xlsx『會計科目』分頁（105 列）＋ A 階段補建 4 個科目。
...
const ROWS: readonly AccountRow[] = [
  ...
  { code: '1901',  name: '開辦費',                 level: 3, parent: '19',   postable: true,  cf: 'I',  dept: false, partner: false, scope: 'PARTNER', tax: 'P5',   section: null,          active: false, remark: '⚠ A 階段停用（不刪，留痕待記帳士確認）：現行商業會計處理準則已刪除開辦費的遞延資產屬性，開辦費用應於發生時列費用。亞羅待補清單第 72 項。原說明：設立登記、資本額簽證、規費' },
  ...
  { code: '2115',  name: '應付特休假薪資',             level: 3, parent: '21',   postable: true,  cf: 'O',  dept: true,  partner: false, scope: 'PARTNER', tax: null,   section: null,          active: true,  remark: '勞基法 2017 修法後未休特休一律折發工資：逐月累積、年底一次爆發的負債。PAY-LV 交易代號引用本科目，但亞羅科目表未建（其待補清單第 54 項）→ A 階段補建。' },
  { code: '2116',  name: '應付獎金（獎金池）',           level: 3, parent: '21',   postable: true,  cf: 'O',  dept: true,  partner: false, scope: 'PARTNER', tax: null,   section: null,          active: true,  remark: '獎金池提撥與動用。⛔ 不可塞 2111 應付費用（該格已給員工代墊報支用）。BON-P／BON-U 引用本科目，亞羅科目表未建（待補清單第 88 項）→ A 階段補建。' },
  ...
  { code: '6411',  name: '什項購置',                level: 3, parent: '64',   postable: true,  cf: 'O',  dept: true,  partner: false, scope: 'PARTNER', tax: 'P5',   section: null,          active: true,  remark: '單價未達資本化門檻的設備一次列費用。⚠ 不塞 6409 什項支出——6409 有一道 2% 的品質閘，開辦期光監視系統＋事務機就是 11 萬會一次撞破。FA-EXP 引用本科目（待補清單第 70 項）→ A 階段補建。' },
  ...
  { code: '7103',  name: '財產交易利益',              level: 3, parent: '71',   postable: true,  cf: 'I',  dept: true,  partner: false, scope: 'PARTNER', tax: null,   section: null,          active: true,  remark: '與 8102 財產交易損失對稱。⭐ 可複用的檢查：凡是有損失科目而沒有對稱利益科目的地方，遲早會有一筆錢無處可放。FA-DISP 第 5 行引用（待補清單第 71 項）→ A 階段補建。' },
