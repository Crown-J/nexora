...
const RULES: readonly RuleRow[] = [
  ...
  { code: 'OPEN-BF',    name: '期初存貨（承接·來源不明）',       cycle: 'INVENTORY',  legal: 'INVENTORY',        status: 'ACTIVE',   remark: '🆕 C 階段 2026-08-01 執行長拍板新增。⭐ 為什麼原本三個代號不夠用：OPEN-AP／OPEN-CA／OPEN-EQ 都要知道「這批貨當初是怎麼來的」（賒欠／現購／實物出資），但從舊系統承接的庫存**根本沒有這個資訊**——恆迎 2.32 億就是這種。硬選一個等於憑空生出一筆負債或現金流出。這一條的對方科目是 3103 期初承接權益，把「開帳帶進來的」與「營運賺來的」永久分開。⚠ 一次性，開帳後不應再用。' },
  { code: 'OPEN-EQ',    name: '期初存貨（實物出資）',          cycle: 'INVENTORY',  legal: 'INVENTORY',        status: 'ACTIVE',   remark: null },
  { code: 'OPEN-RCV',   name: '期初應收（承接）',             cycle: 'SALES',      legal: 'SALES_RECEIPT',    status: 'ACTIVE',   remark: '🆕 C 階段 2026-08-01：開帳日當天客戶還欠的錢。⭐ 借方兩格分開——客戶欠的貨款走 1111，廠商該退我方的錢走 1113，同一個數字不能同時代表兩件事。對方科目與期初存貨一致，都是 3103 期初承接權益。⚠ 一次性、每個往來對象一張傳票（應收本來就是掛在對象身上的）。' },
  { code: 'OPEN-PAY',   name: '期初應付（承接）',             cycle: 'PURCHASE',   legal: 'PURCHASE_PAYMENT', status: 'ACTIVE',   remark: '🆕 C 階段 2026-08-01：開帳日當天我方還欠廠商的錢。⚠ 一次性、每個往來對象一張傳票。⛔ 代號不能叫 OPEN-AP——那個已經被「期初存貨（承接·賒欠）」用掉了，兩者是完全不同的事。' },
...
const LINES: readonly LineRow[] = [
  ...
  { rule: 'EMP-EXP',    no:  2, dc: 'D', acc: '1133',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）', remark: null },
  ...
  { rule: 'EQ-IN',      no:  3, dc: 'C', acc: '3102',   pattern: null,         basis: 'AMOUNT', dept: false, partner: false, scope: 'PARTNER', bank: true,  optional: true,  cond: '金額基礎（原文）：超過面額部分　條件性出現：🆕 v2 ·『回頭要補的』#53 ＋ #48。🔴 `3102 資本公積` 是 v2 才補的科目——**沒有它，超過面額的出資無處可放。**⚠ 有限公司通常按出資額計股本、不必然有溢價，但股東分次增資、換算比例不同時就會出現差額（記帳士確認）。', remark: '金額基礎（原文）：超過面額部分。🆕 v2 ·『回頭要補的』#53 ＋ #48。🔴 `3102 資本公積` 是 v2 才補的科目——**沒有它，超過面額的出資無處可放。**⚠ 有限公司通常按出資額計股本、不必然有溢價，但股東分次增資、換算比例不同時就會出現差額（記帳士確認）。' },
  ...
  { rule: 'EX-D',       no:  2, dc: 'D', acc: '1133',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）', remark: null },
  ...
  { rule: 'IADJ',       no:  1, dc: 'D', acc: '1121',   pattern: null,         basis: 'DIFF',   dept: true,  partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：盤盈',                              remark: '盤盈' },
  { rule: 'IADJ',       no:  2, dc: 'C', acc: '5103',   pattern: null,         basis: 'DIFF',   dept: true,  partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：盤盈',                              remark: '盤盈' },
  { rule: 'IADJ',       no:  3, dc: 'D', acc: '5103',   pattern: null,         basis: 'DIFF',   dept: true,  partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：盤虧',                              remark: '盤虧' },
  { rule: 'IADJ',       no:  4, dc: 'C', acc: '1121',   pattern: null,         basis: 'DIFF',   dept: true,  partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：盤虧 盈與虧擇一。5103 的餘額＝『庫位制度有沒有落實』的直接量測，也是倉管 KPI 計分依據（1-b 起）。', remark: '盤虧 盈與虧擇一。5103 的餘額＝『庫位制度有沒有落實』的直接量測，也是倉管 KPI 計分依據（1-b 起）。' },
  ...
  { rule: 'OPEN-AP',    no:  2, dc: 'D', acc: '1133',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）', remark: '⚠ 須取得合法憑證才可扣抵' },
  ...
  { rule: 'OPEN-CA',    no:  2, dc: 'D', acc: '1133',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）', remark: null },
  ...
  { rule: 'OPEN-BF',    no:  1, dc: 'D', acc: '1121',   pattern: null,         basis: 'AMOUNT', dept: true,  partner: false, scope: 'PARTNER', bank: false, optional: false, cond: null,                                    remark: '承接進來的庫存價值' },
  { rule: 'OPEN-BF',    no:  2, dc: 'C', acc: '3103',   pattern: null,         basis: 'AMOUNT', dept: false, partner: false, scope: 'PARTNER', bank: false, optional: false, cond: null,                                    remark: '⛔ 不是 3201 累積盈餘——那個數字的意思是「過去營運賺了多少」。' },
  { rule: 'OPEN-RCV',   no:  1, dc: 'D', acc: '1111',   pattern: null,         basis: 'AR_TRADE', dept: false, partner: true,  scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：該對象有客戶應收（欠我們貨款）',            remark: '客戶欠的貨款' },
  { rule: 'OPEN-RCV',   no:  2, dc: 'D', acc: '1113',   pattern: null,         basis: 'AR_OTHER', dept: false, partner: true,  scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：該對象有廠商退款應收（進貨退出）',           remark: '廠商該退我方的錢' },
  { rule: 'OPEN-RCV',   no:  3, dc: 'C', acc: '3103',   pattern: null,         basis: 'AMOUNT', dept: false, partner: false, scope: 'PARTNER', bank: false, optional: false, cond: null,                                    remark: '兩種應收的合計。⛔ 不是 3201 累積盈餘。' },
  { rule: 'OPEN-PAY',   no:  1, dc: 'D', acc: '3103',   pattern: null,         basis: 'AMOUNT', dept: false, partner: false, scope: 'PARTNER', bank: false, optional: false, cond: null,                                    remark: '⛔ 不是 3201 累積盈餘。承接進來的負債同樣掛在期初承接權益。' },
  { rule: 'OPEN-PAY',   no:  2, dc: 'C', acc: '2101',   pattern: null,         basis: 'AMOUNT', dept: false, partner: true,  scope: 'PARTNER', bank: false, optional: false, cond: null,                                    remark: '我方還欠廠商的貨款' },
  ...
  { rule: 'PC-EXP',     no:  2, dc: 'D', acc: '1133',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: true,  optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）',                                    remark: null },
  ...
  { rule: 'PD',         no:  3, dc: 'C', acc: '1133',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）', remark: '沖回原先認列的進項稅額' },
  ...
  { rule: 'PO',         no:  2, dc: 'D', acc: '1133',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）', remark: '進項稅額' },
  ...
  { rule: 'PO-IMP',     no:  2, dc: 'D', acc: '1133',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）', remark: '⚠ 進口營業稅走這裡，不進 1122' },
  ...
  { rule: 'PO-RCV',     no:  2, dc: 'D', acc: '1133',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）', remark: '此時才有發票' },
  { rule: 'PO-RCV',     no:  3, dc: 'C', acc: '1131',   pattern: null,         basis: 'PAID',   dept: false, partner: true,  scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：',                                remark: null },
  { rule: 'PO-RCV',     no:  4, dc: 'C', acc: '2101',   pattern: null,         basis: 'UNPAID', dept: false, partner: true,  scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：若尚有尾款未付 ⚠ 分批到貨時 1131 要能分次沖銷（一對多）——執行長 7/30：缺櫃或戰爭會導致國外分批到貨。', remark: '若尚有尾款未付 ⚠ 分批到貨時 1131 要能分次沖銷（一對多）——執行長 7/30：缺櫃或戰爭會導致國外分批到貨。' },
  ...
  { rule: 'PO-TR',      no:  2, dc: 'D', acc: '1133',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）', remark: null },
  ...
  { rule: 'PR',         no:  1, dc: 'D', acc: '2101',   pattern: null,         basis: 'GROSS',  dept: false, partner: true,  scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：沖抵應付（貨款還沒付）。借方二選一、比照 WCLM 的三選一形狀。', remark: '沖抵應付（貨款還沒付）' },
  ...
  { rule: 'PR',         no:  4, dc: 'D', acc: '1113',   pattern: null,         basis: 'GROSS',  dept: false, partner: true,  scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：廠商退款（貨款已付、廠商欠我方退款）。🔴 2026-08-01 執行長拍板：這筆應收要跟客戶的 1111 應收帳款分開——同一個數字不能同時代表「客戶欠我們貨款」跟「廠商該退我們錢」。系統實測就是走這條（PR 過帳建的是應收、不是沖應付）。', remark: '廠商退款（貨款已付）' },
  { rule: 'PR',         no:  3, dc: 'C', acc: '1133',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）', remark: null },
  ...
  { rule: 'SD',         no:  2, dc: 'D', acc: '2121',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）', remark: null },
  ...
  { rule: 'SO-CA',      no:  3, dc: 'C', acc: '2121',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）', remark: null },
  { rule: 'SO-CA',      no:  4, dc: 'D', acc: '5101',   pattern: null,         basis: 'COST',   dept: true,  partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：',                                remark: null },
  { rule: 'SO-CA',      no:  5, dc: 'C', acc: '1121',   pattern: null,         basis: 'COST',   dept: true,  partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：',                                remark: null },
  ...
  { rule: 'SO-CR',      no:  3, dc: 'C', acc: '2121',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）', remark: '銷項稅額' },
  { rule: 'SO-CR',      no:  4, dc: 'D', acc: '5101',   pattern: null,         basis: 'COST',   dept: true,  partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：結轉成本（永續盤存）',                      remark: '結轉成本（永續盤存）' },
  { rule: 'SO-CR',      no:  5, dc: 'C', acc: '1121',   pattern: null,         basis: 'COST',   dept: true,  partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：存貨減少',                            remark: '存貨減少' },
  ...
  { rule: 'SO-DLV',     no:  3, dc: 'C', acc: '2121',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）', remark: '銷項稅額——發票開在這一段' },
  ...
  { rule: 'SR',         no:  2, dc: 'D', acc: '2121',   pattern: null,         basis: 'TAX',    dept: false, partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：稅額為 0 時不產生本行（免稅／零稅率／免用統一發票的小規模對象）', remark: '沖回銷項稅額' },
  { rule: 'SR',         no:  3, dc: 'C', acc: '1111',   pattern: null,         basis: 'GROSS',  dept: false, partner: true,  scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：折抵未來貨款（客戶下次採購扣掉）。貸方二選一。', remark: '折抵未來貨款' },
  { rule: 'SR',         no:  6, dc: 'C', acc: '2142',   pattern: null,         basis: 'GROSS',  dept: false, partner: true,  scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：現金退回（我們要把錢還給客戶）。🔴 2026-08-01 執行長拍板新增：退現金是**負債**、不是應收的減少。記成貸 1111 會讓帳面顯示兩不相欠，但真實方向相反——我們欠客戶錢，退款義務會就此從報表上消失。', remark: '現金退回（欠客戶的錢）' },
  { rule: 'SR',         no:  4, dc: 'D', acc: '1121',   pattern: null,         basis: 'COST',   dept: true,  partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：貨退回入庫',                           remark: '貨退回入庫' },
  { rule: 'SR',         no:  5, dc: 'C', acc: '5101',   pattern: null,         basis: 'COST',   dept: true,  partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：',                                remark: null },
  ...
  { rule: 'WCLM',       no:  1, dc: 'D', acc: '1121',   pattern: null,         basis: 'AMOUNT', dept: true,  partner: false, scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：廠商換新品',                           remark: '廠商換新品' },
  { rule: 'WCLM',       no:  2, dc: 'D', acc: '1113',   pattern: null,         basis: 'AMOUNT', dept: false, partner: true,  scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：廠商退款',                            remark: '廠商退款' },
  { rule: 'WCLM',       no:  3, dc: 'D', acc: '2101',   pattern: null,         basis: 'AMOUNT', dept: false, partner: true,  scope: 'PARTNER', bank: false, optional: true,  cond: '條件性出現：沖抵應付',                            remark: '沖抵應付' },
