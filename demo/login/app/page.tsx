...
import { PlanetOrbit, ParticleField } from "@/components/planet-orbit"

export default function LoginPage() {
  return (
    <main className="min-h-screen min-h-dvh bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen min-h-dvh flex flex-col lg:flex-row">
        ...
        {/* Desktop: Left Side - Brand & Visual */}
        <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative flex-col items-center justify-center">
          ...
          <div className="relative z-10 mt-8 text-center px-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <span className="text-xs tracking-[0.3em] text-accent font-mono">ENTERPRISE RESOURCE PLANNING</span>
        ...
        <div className="w-full lg:w-1/2 xl:w-2/5 flex flex-col px-6 pb-6 lg:p-0">
          ...
          <div className="flex-1 flex items-start lg:items-center justify-center lg:p-12">
            <div className="w-full max-w-md space-y-6">
              ...
              {/* Login Card */}
              <div className="bg-card/60 backdrop-blur-md border border-border/40 rounded-2xl p-5 lg:p-8 relative overflow-hidden">
                {/* Subtle glow effect */}
