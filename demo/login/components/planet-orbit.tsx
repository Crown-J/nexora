...
export function PlanetOrbit({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // Draw orbital rings - metallic industrial style
      const orbits = [
      ...
      orbits.forEach((orbit, index) => {
        ...
        // Draw orbit path with metallic gradient effect
        ctx.beginPath();
        ...
        // Draw tick marks on orbit (industrial feel)
        if (orbit.hasGear) {
          const tickCount = 36;
        ...
        // Draw orbiting component (bolt/rivet style)
        ...
        // Inner bright core - golden yellow
        ctx.beginPath();
        ctx.arc(dotX, dotY, 2.5, 0, Math.PI * 2);
        ctx.fillStyle = "rgba(255, 200, 80, 0.95)";
        ctx.fill();

        // Draw glow for dot - golden yellow
      ...
      // Draw center planet - Industrial metallic style
      ...
      // Draw planet surface details - Industrial tech pattern
      ctx.save();
      ctx.beginPath();
      ctx.arc(centerX, centerY, planetRadius, 0, Math.PI * 2);
      ctx.clip();
      ...
      // Metallic hex pattern (industrial grid)
      const hexSize = 12;
      ...
      // Gear-like notches around equator
      const notchCount = 24;
      ...
      // Center tech core - golden yellow
      ...
      // Inner ring detail - golden yellow
      ctx.beginPath();
