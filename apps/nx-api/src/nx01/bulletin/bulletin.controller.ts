...
import { CreateBulletinDto, ListBulletinQueryDto, UpdateBulletinDto } from './dto/bulletin.dto';
...
export class BulletinController {
  ...
  @Patch(':id')
  update(@CurrentUser() user: RequestUser, @Param('id') id: string, @Body() dto: UpdateBulletinDto) {
