...
import { CreateWarehouseDto, ListWarehouseQueryDto, UpdateWarehouseDto } from './dto/warehouse.dto';
import { WarehouseService } from './warehouse.service';

@Controller('nx01/warehouses')
...
export class WarehouseController {
  ...
  @Get()
  list(@CurrentUser() user: RequestUser, @Query() q: ListWarehouseQueryDto) {
