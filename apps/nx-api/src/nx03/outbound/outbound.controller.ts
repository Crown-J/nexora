...
import { CreateOutboundDto, CreateOutboundItemDto, PatchOutboundItemDto, UpdateOutboundDto } from './dto/outbound.dto';
...
export class OutboundController {
  ...
  @Post(':id/items')
  addItem(@CurrentUser() user: RequestUser, @Param('id') id: string, @Body() dto: CreateOutboundItemDto) {
  ...
  @Post()
  create(@CurrentUser() user: RequestUser, @Body() dto: CreateOutboundDto) {
    return this.svc.create(user, dto);
  }

  @Patch(':id')
  update(@CurrentUser() user: RequestUser, @Param('id') id: string, @Body() dto: UpdateOutboundDto) {
