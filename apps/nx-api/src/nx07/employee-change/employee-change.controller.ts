...
import { Nx07EmployeeChangeService } from './employee-change.service';
...
export class Nx07EmployeeChangeController {
  ...
  @Post()
  create(@CurrentUser() user: RequestUser, @Body() dto: CreateEmployeeChangeDto) {
    return this.svc.create(user, dto);
  }

  @Patch(':id')
  patch(@CurrentUser() user: RequestUser, @Param('id') id: string, @Body() dto: PatchEmployeeChangeDto) {
