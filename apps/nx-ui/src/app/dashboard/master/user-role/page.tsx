// apps/nx-ui/src/app/dashboard/master/user-role/page.tsx
...
import { listRoles } from '@data/endpoints/nx01/api/role';
import { listUserRoles, assignUserRole, revokeUserRole } from '@data/endpoints/nx01/api/user-role';
