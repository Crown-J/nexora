// apps/nx-ui/src/app/dashboard/base/part-compat-group/[id]/page.tsx
  ...
  return (
    <div className="space-y-4 p-6">
      <div className="flex items-center gap-3">
        <Link href="/dashboard/base/part-compat-group" className="text-xs text-[#888892] hover:text-[#E8E8EC]">
          ← 回通用件群組
        </Link>
      </div>
