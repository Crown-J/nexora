    ...
    sub: [
      {
        ...
        label: '組織架構',
        sub: [
          { key: 'users', label: '員工', href: '/dashboard/master/users' },
          { key: 'departments', label: '部門', href: '/dashboard/master/departments' },
          { key: 'roles', label: '職務', href: '/dashboard/master/roles' },
          { key: 'teams', label: '組別', href: '/dashboard/master/teams' },
        ],
      },
      {
        key: 'rbac',
        label: '權限管理',
        sub: [
          { key: 'role-view', label: '角色與權限', href: '/dashboard/master/role-view' },
          { key: 'user-role', label: '員工角色', href: '/dashboard/master/user-role' },
        ],
      },
      {
        key: 'site',
        label: '據點倉庫',
        sub: [
          { key: 'sites', label: '據點', href: '/dashboard/master/site' },
          { key: 'warehouses', label: '倉庫', href: '/dashboard/master/warehouses' },
          { key: 'locations', label: '庫位', href: '/dashboard/master/location' },
          { key: 'user-warehouse', label: '員工倉庫', href: '/dashboard/master/user-warehouse' },
        ],
      },
      {
        key: 'partner',
        label: '往來對象',
        sub: [
          { key: 'partners', label: '客戶/供應商', href: '/dashboard/master/partners' },
          { key: 'cust-grade', label: '客戶分級', href: '/dashboard/master/customer-grade' },
          { key: 'supp-grade', label: '供應商分級', href: '/dashboard/master/supplier-grade' },
        ],
      },
      {
        key: 'part',
        label: '產品與廠牌',
        sub: [
          { key: 'parts', label: '零件', href: '/dashboard/master/parts' },
          { key: 'brand', label: '廠牌', href: '/dashboard/master/car-brand' },
          { key: 'part-group', label: '零件群組', href: '/dashboard/master/part-group' },
          { key: 'partner-part', label: '供應商供貨對應', href: '/dashboard/master/partner-part' },
        ],
      },
      {
        key: 'dict',
        label: '字典主檔',
        sub: [
          { key: 'currency', label: '幣別', href: '/dashboard/master/currency' },
          { key: 'country', label: '國家', href: '/dashboard/master/country' },
          { key: 'phonetic', label: '注音字典', href: '/dashboard/master/phonetic-dictionary' },
        ],
      },
    ],
  },
