...
import { ScopePicker } from '@/features/nx04/promotion/ui/ScopePicker';

import { createBundle, listBundle } from '@data/endpoints/nx04/bundle/api/bundle';
import type { Bundle, CreateBundleItemPayload, CreateBundlePayload } from '@data/types/nx04/bundle';
        ...
        <div className="mt-3 grid grid-cols-2 gap-3 text-sm">
          <label className="block">
            ...
            <input
              ...
              className="mt-1 w-full rounded-md border bg-background px-2 py-1 font-mono text-[14px] uppercase"
            />
          </label>
          <label className="block">
