...
export type InstantStationNo = 1 | 2 | 3 | 4;
...
export const INSTANT_STATIONS: InstantStationDef[] = [
  ...
  // 站 4：即時補貨（補貨籃、C 期；批次產單型別待執行長用實例拍板）
  { no: 4, id: 'replenish-basket', label: '即時補貨', anchor: 'basket', status: 'planned' },
];
