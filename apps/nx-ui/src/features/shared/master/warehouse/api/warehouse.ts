/**
 * File: apps/nx-ui/src/features/shared/master/warehouse/api/warehouse.ts
...
export async function getWarehouseSingle(): Promise<WarehouseDto | null> {
    ...
    await assertOk(res, 'nxui_master_warehouse_single_get_001');
...
export async function createWarehouseSingle(
    ...
    await assertOk(res, 'nxui_master_warehouse_single_create_001');
...
export async function updateWarehouseSingle(
    ...
    await assertOk(res, 'nxui_master_warehouse_single_update_001');
    return (await res.json()) as WarehouseDto;
}