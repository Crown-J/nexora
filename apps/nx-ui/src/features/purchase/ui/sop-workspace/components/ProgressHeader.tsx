// apps/nx-ui/src/features/purchase/ui/sop-workspace/components/ProgressHeader.tsx
/**
 * 國內進貨 SOP 頂部流程進度條（sticky top）
 * - 9 節點捷運圖：已完成=綠、當前=金、未到=灰
 * - 顯示當前步驟標題 + 副標題（SOP 內建語意）
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/10 bg-black/95 px-4 py-3 backdrop-blur">
      ...
      <ol
        ...
        aria-label={`採購流程，目前第 ${currentStep} 步`}
      >
