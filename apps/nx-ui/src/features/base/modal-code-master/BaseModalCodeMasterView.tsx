...
export function BaseModalCodeMasterView({ variant }: { variant: Nx00ModalCodeVariant }) {
  ...
  const detailModalNarrowCls = useMemo(
    () => (variant === 'currency' ? 'w-[min(92vw,36rem)]' : 'w-[min(92vw,30rem)]'),
    [variant],
  );
  ...
  return (
    <div className="relative flex flex-col gap-4">
      ...
      <BaseMasterModalFrame
        ...
        modalSizeClassName={detailModalNarrowCls}
      >
        <div className="mt-4">
...
export function BaseCountryModalMasterView() {
  return <BaseModalCodeMasterView variant="country" />;
}

export function BaseCurrencyModalMasterView() {
  return <BaseModalCodeMasterView variant="currency" />;
}

export function BasePartGroupModalMasterView() {
  return <BaseModalCodeMasterView variant="partGroup" />;
}
