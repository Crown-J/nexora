...
export const MASTER_HUB_CARDS: MasterHubCard[] = [
  ...
  },
  {
    ...
    minPlan: 'PLUS',
    title: '變速箱主檔',
    description: '自手排／CVT／DCT 等變速箱類型代碼',
    icon: Settings2,
    statLabel: '變速箱',
    statValue: '—',
  ...
  },
  {
    ...
    minPlan: 'PLUS',
    title: '驅動方式主檔',
    description: 'FF／FR／4WD／AWD 驅動配置代碼',
    icon: Wrench,
    statLabel: '驅動',
    statValue: '—',
  ...
  // ─── 系統設定延伸（注音字典、PRO）─────────────────────────────────
  {
    ...
    minPlan: 'PRO',
    title: '注音字典主檔',
    description: '料號／品名注音對照、加速櫃台快速搜尋（PRO 限定）',
    icon: BookOpen,
    statLabel: '字典條目',
    statValue: '—',
