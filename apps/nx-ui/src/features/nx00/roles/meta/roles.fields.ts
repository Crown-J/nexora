/**
 * File: apps/nx-ui/src/features/nx00/roles/meta/roles.fields.ts
 * Project: NEXORA (Monorepo)
 *
 * Purpose:
 * - NX00-UI-NX00-ROLES-FIELDS-001：Roles fields meta（中文標籤/列表預設/排序/篩選）
 *
 * Notes:
...
export const ROLES_FIELDS: RolesFieldDef[] = [
