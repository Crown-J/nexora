                                                        ...
                                                        >
                                                            <td className="px-3 py-2">
                                                                <div className="flex items-start justify-between gap-2">
                                                                    ...
                                                                    <button
                                                                        type="button"
                                                                        className="shrink-0 rounded-full border border-white/10 bg-white/5 px-2 py-1 text-[10px] font-semibold text-white/75 hover:bg-white/10 disabled:opacity-40"
                                                                        onClick={() => vm.actions.toggleRowAll(r.view.id)}
                                                                        disabled={vm.saving}
